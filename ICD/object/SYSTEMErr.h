...
class acserrGen_EXPORT ProposalDoesNotExistCompletion: public ACSErr::CompletionImpl
{
	static const ACSErr::ACSErrType m_etype=ACSErr::SYSTEMErr; // = 900907
	static const ACSErr::ErrorCode m_code = ProposalDoesNotExist;
	static const char m_shortDescription[];
	...
	const char * getShortDescription() { return ProposalDoesNotExistCompletion::m_shortDescription; }
		
	ProposalDoesNotExistCompletion (const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
					
	ProposalDoesNotExistCompletion (ACSErr::Completion *pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(*pc, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
		
	ProposalDoesNotExistCompletion (const ACSErr::Completion &pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(pc, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
		
	ProposalDoesNotExistCompletion (ACSErr::CompletionImpl *pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(pc, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
		
	ProposalDoesNotExistCompletion (const ACSErr::ErrorTrace &et, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(et, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}	
						
	template <class T >
	ProposalDoesNotExistCompletion (const T &pe, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(ETHolder<T>(pe).getErrorTrace(), m_etype, m_code, file, line, routine, m_shortDescription, severity) {}

};

class acserrGen_EXPORT TargetDoesNotExistCompletion: public ACSErr::CompletionImpl
{
	static const ACSErr::ACSErrType m_etype=ACSErr::SYSTEMErr; // = 900907
	static const ACSErr::ErrorCode m_code = TargetDoesNotExist;
	static const char m_shortDescription[];
	...
	const char * getShortDescription() { return TargetDoesNotExistCompletion::m_shortDescription; }
		
	TargetDoesNotExistCompletion (const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
					
	TargetDoesNotExistCompletion (ACSErr::Completion *pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(*pc, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
		
	TargetDoesNotExistCompletion (const ACSErr::Completion &pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(pc, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
		
	TargetDoesNotExistCompletion (ACSErr::CompletionImpl *pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(pc, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
		
	TargetDoesNotExistCompletion (const ACSErr::ErrorTrace &et, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(et, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}	
						
	template <class T >
	TargetDoesNotExistCompletion (const T &pe, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
		ACSErr::CompletionImpl(ETHolder<T>(pe).getErrorTrace(), m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
...
class acserrGen_EXPORT ProposalDoesNotExistExImpl: public SYSTEMErrExImpl
{
	static const ACSErr::ACSErrType m_etype=ACSErr::SYSTEMErr;
	static const ACSErr::ErrorCode m_code = ProposalDoesNotExist;
	static const char m_shortDescription[]  ;
	...
	public:
        ...
        static const char * getShortDescription() { return m_shortDescription;}
	ProposalDoesNotExistExImpl(const ProposalDoesNotExistExImpl& ex) :
			SYSTEMErrExImpl(const_cast<ProposalDoesNotExistExImpl&>(ex).getErrorTrace()) {}
		
	ProposalDoesNotExistExImpl (const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl(m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
	
	ProposalDoesNotExistExImpl (const ACSErr::ErrorTrace &et, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl(et, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
				
	ProposalDoesNotExistExImpl (ACSErr::CompletionImpl *pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl((pc->isErrorFree() ? ACSErr::ErrorTrace()  : pc->getErrorTraceHelper()->getErrorTrace()), m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
				
	ProposalDoesNotExistExImpl (const SYSTEMErr::ProposalDoesNotExistEx & ex) : 
			SYSTEMErrExImpl(ex.errorTrace) {}
			
	SYSTEMErr::ProposalDoesNotExistEx getProposalDoesNotExistEx () { return SYSTEMErr::ProposalDoesNotExistEx (getErrorTrace()); }
	
	template <class T >
	ProposalDoesNotExistExImpl (const T& pe, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl(ETHolder<T>(pe).getErrorTrace(), m_etype, m_code, file, line, routine, m_shortDescription, severity) {}


};

class acserrGen_EXPORT TargetDoesNotExistExImpl: public SYSTEMErrExImpl
{
	static const ACSErr::ACSErrType m_etype=ACSErr::SYSTEMErr;
	static const ACSErr::ErrorCode m_code = TargetDoesNotExist;
	static const char m_shortDescription[]  ;
	...
	public:
        ...
        static const char * getShortDescription() { return m_shortDescription;}
	TargetDoesNotExistExImpl(const TargetDoesNotExistExImpl& ex) :
			SYSTEMErrExImpl(const_cast<TargetDoesNotExistExImpl&>(ex).getErrorTrace()) {}
		
	TargetDoesNotExistExImpl (const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl(m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
	
	TargetDoesNotExistExImpl (const ACSErr::ErrorTrace &et, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl(et, m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
				
	TargetDoesNotExistExImpl (ACSErr::CompletionImpl *pc, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl((pc->isErrorFree() ? ACSErr::ErrorTrace()  : pc->getErrorTraceHelper()->getErrorTrace()), m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
				
	TargetDoesNotExistExImpl (const SYSTEMErr::TargetDoesNotExistEx & ex) : 
			SYSTEMErrExImpl(ex.errorTrace) {}
			
	SYSTEMErr::TargetDoesNotExistEx getTargetDoesNotExistEx () { return SYSTEMErr::TargetDoesNotExistEx (getErrorTrace()); }
	
	template <class T >
	TargetDoesNotExistExImpl (const T& pe, const char* file, int line, const char* routine, ACSErr::Severity severity=DEFAULT_SEVERITY) : 
			SYSTEMErrExImpl(ETHolder<T>(pe).getErrorTrace(), m_etype, m_code, file, line, routine, m_shortDescription, severity) {}
