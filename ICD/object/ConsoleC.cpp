...
TAO::Objref_Traits<CONSOLE_MODULE::Console>::duplicate (CONSOLE_MODULE::Console_ptr p)
{
  return CONSOLE_MODULE::Console::_duplicate (p);
}

void
TAO::Objref_Traits<CONSOLE_MODULE::Console>::release (CONSOLE_MODULE::Console_ptr p)
{
  ::CORBA::release (p);
}

CONSOLE_MODULE::Console_ptr
TAO::Objref_Traits<CONSOLE_MODULE::Console>::nil ()
{
  return CONSOLE_MODULE::Console::_nil ();
}

::CORBA::Boolean
TAO::Objref_Traits<CONSOLE_MODULE::Console>::marshal (const CONSOLE_MODULE::Console_ptr p,TAO_OutputCDR & cdr)
{
...
CONSOLE_MODULE::Console_ptr
CONSOLE_MODULE::Console::_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<Console>::narrow (_tao_objref, "IDL:acsws/CONSOLE_MODULE/Console:1.0");
}

CONSOLE_MODULE::Console_ptr
CONSOLE_MODULE::Console::_unchecked_narrow (::CORBA::Object_ptr _tao_objref)
{
  return TAO::Narrow_Utils<Console>::unchecked_narrow (_tao_objref);
}

CONSOLE_MODULE::Console_ptr
CONSOLE_MODULE::Console::_nil ()
{
  return nullptr;
}
...
const char* CONSOLE_MODULE::Console::_interface_repository_id () const
{
    ...
    CONSOLE_MODULE::Console_ptr &_tao_objref)
{
  ...
  _tao_objref = TAO::Narrow_Utils< ::CONSOLE_MODULE::Console>::unchecked_narrow (obj.in ());
