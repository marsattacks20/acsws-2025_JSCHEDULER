...
const char SYSTEMErr::ProposalDoesNotExistCompletion::m_shortDescription[]="Proposal doesn't exist.";
bool SYSTEMErr::ProposalDoesNotExistCompletion::isEqual(ACSErr::Completion &completion) { return (completion.type == m_etype && completion.code == m_code ); }
        
const char SYSTEMErr::TargetDoesNotExistCompletion::m_shortDescription[]="Target doesn't exist.";
bool SYSTEMErr::TargetDoesNotExistCompletion::isEqual(ACSErr::Completion &completion) { return (completion.type == m_etype && completion.code == m_code ); }
...
const char SYSTEMErr::ProposalDoesNotExistExImpl::m_shortDescription[]="Proposal doesn't exist.";
bool SYSTEMErr::ProposalDoesNotExistExImpl::isEqual(ACSErr::ACSbaseExImpl &ex) { return (ex.getErrorType() == m_etype && ex.getErrorCode() == m_code ); }
        
const char SYSTEMErr::TargetDoesNotExistExImpl::m_shortDescription[]="Target doesn't exist.";
bool SYSTEMErr::TargetDoesNotExistExImpl::isEqual(ACSErr::ACSbaseExImpl &ex) { return (ex.getErrorType() == m_etype && ex.getErrorCode() == m_code ); }
