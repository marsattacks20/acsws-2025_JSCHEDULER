...
######################################################################
class ProposalDoesNotExistExImpl(SYSTEMErr.ProposalDoesNotExistEx, ACSError, BaseException):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
    def __init__(self,
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Proposal doesn't exist."
        description = self.shortDescription
        ACSError.__init__(self,  
                          ACSErr.SYSTEMErr,
                          SYSTEMErr.ProposalDoesNotExist,
                          exception,
                          description,
                          nvSeq,                          
                          create,
                          severity)
        SYSTEMErr.ProposalDoesNotExistEx.__init__(self, self.errorTrace)
        return
    #--------------------------------------------------------------------------        
    def getSYSTEMErrEx(self):
        '''
...
######################################################################
class TargetDoesNotExistExImpl(SYSTEMErr.TargetDoesNotExistEx, ACSError, BaseException):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
    def __init__(self,
        ...
        if nvSeq == None:
            nvSeq = []
        self.shortDescription = "Target doesn't exist."
        description = self.shortDescription
        ACSError.__init__(self,  
                          ACSErr.SYSTEMErr,
                          SYSTEMErr.TargetDoesNotExist,
                          exception,
                          description,
                          nvSeq,                          
                          create,
                          severity)
        SYSTEMErr.TargetDoesNotExistEx.__init__(self, self.errorTrace)
        return
    #--------------------------------------------------------------------------        
    def getSYSTEMErrEx(self):
        '''
...
######################################################################
class ProposalDoesNotExistCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
...
######################################################################
class TargetDoesNotExistCompletionImpl(ACSErr.Completion, ACSError):
    '''
    Some form of custom documentation goes here...
    '''
    #-----------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    try:
        raise ProposalDoesNotExistExImpl
    except SYSTEMErr.ProposalDoesNotExistEx as e:
        print("Caught the correct type of exception:", e)
        g = ProposalDoesNotExistExImpl(exception=e)
        g.Print()
    except Exception as e:
        print("Caught the wrong type of exception:", e)

    try:
        raise TargetDoesNotExistExImpl
    except SYSTEMErr.TargetDoesNotExistEx as e:
        print("Caught the correct type of exception:", e)
        g = TargetDoesNotExistExImpl(exception=e)
        g.Print()
    except Exception as e:
        print("Caught the wrong type of exception:", e)
    ...
    joe = ProposalDoesNotExistCompletionImpl()
    joe.Print()


    joe = TargetDoesNotExistCompletionImpl()
    joe.Print()
